...
VM_NAME="ructf-base"
OUTPUT_IMAGE="images/ructf-deploy_$(date +"%Y-%m-%d_%H-%M-%S").ova"
LATEST_IMAGE="images/ructf-deploy.ova"
SSH_PORT=2222
SSH_HOST=127.0.0.1
...
# Deploy updates
ansible-playbook -i ansible_hosts --key-file keys/id_rsa --skip-tags "start_service" studio_image.yml
